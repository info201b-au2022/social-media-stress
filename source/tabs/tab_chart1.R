social_media <- read.csv("https://raw.githubusercontent.com/info201b-au2022/social-media-stress/main/data/General-Social-Media.csv", stringsAsFactors = TRUE, check.names = FALSE)
